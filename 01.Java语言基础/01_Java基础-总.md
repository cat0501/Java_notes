...
- 在java程序中，我们需要判断用户输入数据的合法性，等等。因此，Java提供了一个`throw`关键字，它用来抛出一个指定的异常对象。
  - 创建一个异常对象。封装一些提示信息(信息可以自己编写)。
  - 需要将这个异常对象告知给调用者。通过关键字throw就可以完成。 throw用在方法内，用来抛出一个异常对象，将这个异常对象传递到调用者处，并结束当前方法的执行。
...
![](https://java-notes-1308812086.cos.ap-beijing.myqcloud.com/image-20220415224438975.png)
