...
public class LitemallBrand {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public static LitemallBrand.Builder builder() {
        return new LitemallBrand.Builder();
    }
