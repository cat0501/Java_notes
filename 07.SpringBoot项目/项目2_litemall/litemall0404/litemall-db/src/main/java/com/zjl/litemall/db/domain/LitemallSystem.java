...
public class LitemallSystem {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public static LitemallSystem.Builder builder() {
        return new LitemallSystem.Builder();
    }
