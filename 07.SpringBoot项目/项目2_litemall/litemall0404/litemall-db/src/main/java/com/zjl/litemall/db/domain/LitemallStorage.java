...
public class LitemallStorage {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public static LitemallStorage.Builder builder() {
        return new LitemallStorage.Builder();
    }
