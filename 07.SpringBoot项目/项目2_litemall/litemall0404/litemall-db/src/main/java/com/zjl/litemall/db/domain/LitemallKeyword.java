...
public class LitemallKeyword {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public static LitemallKeyword.Builder builder() {
        return new LitemallKeyword.Builder();
    }
