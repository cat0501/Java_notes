...
public class LitemallIssue {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public static LitemallIssue.Builder builder() {
        return new LitemallIssue.Builder();
    }
