	...
	<form action="${ctx}/resource/save" method="post" id="resourceForm" name="resourceForm" >
	  ...
	  <br />
	    <table width="95%" border="0" cellspacing="0" cellpadding="0" class="add_tab" >
            ...
            <tr>
                <th >服务接口：</th>
                <td ><input name="serviceName" id="serviceName" type="text" class="easyui-validatebox txtbox "  value="${resource.serviceName}"/></td>
                <th >方法名：</th>
                <td>
                    <input name="methodName" id="methodName" type="text" class="easyui-validatebox txtbox" value="${resource.methodName}"/></td>
            </tr>
            <tr>
                <th >传入参数：</th>
                <td ><input name="methodParam" id="methodParam" type="text" class="easyui-validatebox txtbox "  value="${resource.methodParam}"/></td>
                <th >DUBBO版本号：</th>
                <td>
                    <input name="dubboVersion" id="dubboVersion" type="text" class="easyui-validatebox txtbox" value="${resource.dubboVersion}"/></td>
            </tr>
            <tr>
                <th >算法：</th>
                <td ><input name="loadbalance" id="loadbalance" type="text" class="easyui-validatebox txtbox "  value="${resource.loadbalance}"/></td>
                <th >重试次数：</th>
                <td>
                    <input name="timeout" id="timeout" type="text" class="easyui-validatebox txtbox" value="${resource.timeout}"/></td>
            </tr>
            <tr>
                <th >超时时间：</th>
                <td >
                    <input name="retries" id="retries" type="text" class="easyui-validatebox txtbox" value="${resource.retries}"/></td>
            </tr>
            <th>备注：</th>
