...
<div class="easyui-layout" data-options="fit:true">
	    ...
	    <table width="100%" border="0" cellspacing="5" cellpadding="0">
		  <tr>
			...
			<td width="150">
	        	...
	        	<a  href="#" class="easyui-linkbutton"  data-options="iconCls:'icon-reload'" onclick="doReload('${ctx}/user/listInitialize')" >重 置</a>
			</td>
			<td width="*">&nbsp;</td>
		  </tr>
		</table>
    ...
    <div id="toolButton" style="display: none;">
		...
		<a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-tijiaosh'" onclick='startDataInfoRefresh("resList","${ctx}/user/start",false,false)'>启用</a>
		<a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'" onclick='stopDataInfoRefresh("resList","${ctx}/user/stop",false,false)'>禁用</a>
	</div>
</div>
</body>
</html>